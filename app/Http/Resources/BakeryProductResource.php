    ...
    public function toArray(Request $request): array
    {
        ...
        return [
            ...
            'longDescription' => $contentVerified
                ...
                : null,
            'tasteNotes' => $contentVerified
                ? BakeryProduct::normalizeTagList($this->taste_notes)
                : [],
            'textureNotes' => $contentVerified
                ? BakeryProduct::normalizeTagList($this->texture_notes)
                : [],
            'useCases' => $contentVerified
                ? BakeryProduct::normalizeTagList($this->use_cases)
                : [],
            'servingSuggestions' => $contentVerified
                ? $this->publicPlainText($this->serving_suggestions)
                : null,
